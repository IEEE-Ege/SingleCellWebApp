    ...
    def main_ui():
        if logged_in():
            ...
            return ui.div(
                ...
                ui.input_password("confirm_new_password", "Confirm New Password"),
    ...
    async def reset_password_initiate():
        ...
        async with get_db() as db:
            ...
            if user:
                ...
                message.set("Username/email combination incorrect.")
                message_type.set("error")
        ...
        if logged_in() and jwt_token():
            async with get_db() as db:
                ...
                if user:
                    ...
                    message.set("Account could not be verified. Please log in again.")
                    message_type.set("error")
                    await logout()
