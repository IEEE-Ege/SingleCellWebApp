...
service = VisualizationService(
    backend=backend,   # özel backend
    # strategy default UMAPStrategy
)

ctx = service.run_umap(
    data=adata.obsm["X_pca"],   # 👈 kritik değişiklik
...
ax_right.set_title("OOP UMAP (VisualizationService + UMAPStrategy)")
